...
public class StartGUI extends JFrame{
    ...
    public StartGUI() {
        ...
        public void actionPerformed(ActionEvent e) {
            GameGUI gameGUI = new GameGUI((combo1.getSelectedIndex()+1)*2, (combo2.getSelectedIndex() == 0));
            gameGUI.setTitle("Konane ("+combo1.getSelectedItem().toString() +", "+combo2.getSelectedItem().toString() +")");
